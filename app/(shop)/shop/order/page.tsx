      ...
      <div className="container mx-auto max-w-2xl min-h-screen py-10 px-4 sm:px-6 lg:px-8 md:max-w-7xl ">
        <div className="grid grid-cols-5 gap-7">
          <div className="w-full col-span-5 lg:col-span-3">
            <div className="max-w-3xl mx-auto bg-white p-4 rounded-2xl ">
        ...
        <div className="mt-4 flex justify-between">
          ...
          <button
            ...
            className="px-4 py-2 bg-amber-400 text-white rounded font-bold disabled:opacity-50 hover:cursor-pointer"
          >
            Next
          </button>
        </div>
