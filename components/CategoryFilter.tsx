...
const CategoryFilter = () => {
  ...
  const categoryList: FilterType[] =
    categoryData?.data.map((item: CategoryDTO) => ({
            ...
            >
              <div className="flex items-center justify-between px-4">
                ...
                <button
                  ...
                  className="relative -mr-2 flex size-10 items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-50 focus:ring-2 focus:ring-amber-500 focus:outline-hidden"
                >
        ...
        <main className="mx-auto max-w-7xl ">
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ">
              {/* Filters */}
              <form className="hidden lg:block bg-white rounded-2xl p-3">
                {/* NOTE - Category */}
                {filtersCategory.map((section) => (
                  <Disclosure
                    key={section.id}
